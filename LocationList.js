...
function LocationList() {
	...
	const sortByName = () => {
		...
		culturalProgrammesCopy.sort((culturalProgrammeA, culturalProgrammeB) => {
			if (sorted.reversed) {
				return culturalProgrammeB.title.localeCompare(culturalProgrammeA.title);
			}
			return culturalProgrammeA.title.localeCompare(culturalProgrammeB.title);
		});
		setCulturalProgrammes(culturalProgrammesCopy);
		...
		return culturalProgrammes.map((culturalProgramme) => {
			return (
				<tr>
					...
					<td>{culturalProgramme.title}</td>
					<td>{culturalProgramme.venue}</td>
					<td>{culturalProgramme.date}</td>
					<td>{culturalProgramme.time}</td>
					<td>{culturalProgramme.description}</td>
					<td>{culturalProgramme.presenter}</td>
					<td>{culturalProgramme.price}</td>
				</tr>
			);
		});
	};
